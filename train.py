    ...
    def init_weights(self, dtype=torch.bfloat16):
        ...
        for block in self.transformer.h:
            if block.attn.ve_gate is not None:
                torch.nn.init.zeros_(block.attn.ve_gate.weight)  # sigmoid(0)*2 = 1.0 = neutral
...
_CONFIG_CANDIDATES = [
    (24, None), (20, None), (16, None), (14, None), (12, None),
    (10, None), (8, None), (6, None), (5, None), (4, None),
    (3, None), (2, None),
]
...
def estimate_model_memory_mb(depth, n_embd, vocab_size, use_bf16):
    ...
    total_params = attn_params + mlp_params + embed_params + ve_params + gate_params + scalar_params
